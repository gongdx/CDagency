...
class ShiwujuSpider(scrapy.Spider):
    name = 'CD36shiwuju'
    allowed_domains = ['goa.chengdu.gov.cn/']
    start_urls = ['http://goa.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101210017&docQt=&page=1']
    ...
    def parse(self, response):
        ...
        for new in news:
            ...
            # print(href)
            initial_url = 'http://goa.chengdu.gov.cn/search/' + str(href)
    ...
    #
        ...
        next_url = 'http://goa.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101210017&docQt=&page=' + str(int(num)+1)
        if int(num) < 15:
    ...
    def get_text(self, response):
        ...
        content = response.xpath("//div[contains(@class,'dvdetails') or contains(@id,'part')]/ul//p//text()").getall()
