...
class CdCaizhengjujuSpider(scrapy.Spider):

    name = 'CD15caizhengju'
    allowed_domains = ['cdcz.chengdu.gov.cn']
    start_urls = ['http://cdcz.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83+%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&sort=D&database=all&siteCode=5101000030&docQt=&page=1']
    ...
    def parse(self, response):
        ...
        for new in news:
            ...
            # print(href)
            initial_url = 'http://cdcz.chengdu.gov.cn/search/' + str(href)
        ...
        next_url = 'http://cdcz.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83+%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&sort=D&database=all&siteCode=5101000030&docQt=&page=' + str(int(num)+1)
        if int(num) < 15:
    ...
    def get_text(self, response):
        ...
        # 获取详细内容
        content_list = response.xpath('//div[@id="NewsContent"]//text()').getall()
