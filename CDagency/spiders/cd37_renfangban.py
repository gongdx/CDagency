...
class CdRenfangbanSpider(scrapy.Spider):

    name = 'CD37renfangban'
    allowed_domains = ['rfb.chengdu.gov.cn']
    start_urls = ['http://rfb.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%EF%BC%8C%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101000049&docQt=&page=1']
    ...
    def parse(self, response):
        ...
        for new in news:
            ...
            # print(href)
            initial_url = 'http://rfb.chengdu.gov.cn/search/' + str(href)
        ...
        next_url = 'http://rfb.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%EF%BC%8C%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101000049&docQt=&page=' + str(int(num)+1)
        if int(num) < 10:
    ...
    def get_text(self, response):
        ...
        # 获取详细内容
        content_list = response.xpath('//p[contains(@style,"text-indent: 2em") or contains(@style,"TEXT-INDENT: 2em") ]//text()').getall()
