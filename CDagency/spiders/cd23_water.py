...
class CdWaterSpider(scrapy.Spider):
    name = 'CD23water'
    allowed_domains = ['cdwater.chengdu.gov.cn']
    start_urls = ['http://cdwater.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&sort=D&database=all&siteCode=5101000019&docQt=&page=1']
    ...
    def parse(self, response):
        ...
        next_url = 'http://cdwater.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&sort=D&database=all&siteCode=5101000019&docQt=&page=' + str(int(num)+1)
        if int(num) < 15:
    ...
    def get_text(self, response):
        ...
        item = response.meta['item']
        # 获取详细内容
        content_list = response.xpath('//div[@class="ninfo-content"]//text()').getall()
