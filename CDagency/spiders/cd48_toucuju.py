...
class CdToucujuSpider(scrapy.Spider):

    name = 'CD48toucuju'
    allowed_domains = ['cdtc.chengdu.gov.cn']
    start_urls = ['http://cdtc.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101000042&docQt=&page=1']
    ...
    def parse(self, response):
        ...
        for new in news:
            ...
            # print(href)
            initial_url = 'http://cdtc.chengdu.gov.cn/search/' + str(href)
        ...
        next_url = 'http://cdtc.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101000042&docQt=&page=' + str(int(num)+1)
        if int(num) < 15:
