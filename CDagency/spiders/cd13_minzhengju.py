...
class CdMinzhengjuSpider(scrapy.Spider):
    name = 'CD13minzhengju'
    allowed_domains = ['cdmzj.chengdu.gov.cn']
    start_urls = ['http://cdmzj.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&sort=D&database=all&siteCode=5101000021&docQt=&page=1']
    ...
    def parse(self, response):
        ...
        next_url = 'http://cdmzj.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&sort=D&database=all&siteCode=5101000021&docQt=&page=' + str(int(num)+1)
        if int(num) < 15:
    ...
    def get_text(self, response):
        ...
        content_list = response.xpath('.//div[@id="content_case" or @id="detail"]/p//text()').extract()
        # 对文本进行拼接
