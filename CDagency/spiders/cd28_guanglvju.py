...
class CdGuanglvjuSpider(scrapy.Spider):
    name = 'CD28guanglvju'
    ...
    #
        ...
        next_url = 'http://cdwglj.chengdu.gov.cn/search/s?q=1&qt=%E4%B8%8D%E5%BF%98%E5%88%9D%E5%BF%83%E3%80%81%E7%89%A2%E8%AE%B0%E4%BD%BF%E5%91%BD&pageSize=10&database=all&siteCode=5101000037&docQt=&page=' + str(int(num)+1)
        if int(num) < 15:
